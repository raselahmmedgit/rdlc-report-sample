...
namespace lab.RDLCReportSample.Extensions
{
    public static class ObjectExtensions
    {
        ...
        public static string AsJsonList<T>(this List<T> tt)
        {
            return JsonConvert.SerializeObject(tt);
        }
        public static string AsJson<T>(this T t)
        {
            return JsonConvert.SerializeObject(t);
        }
        public static List<T> JsonToObjectList<T>(this string tt)
        {
            return System.Text.Json.JsonSerializer.Deserialize<List<T>>(tt);
        }
        public static Dictionary<string, int> JsonToDictionary(this string tt)
        {
            return System.Text.Json.JsonSerializer.Deserialize<Dictionary<string, int>>(tt);
        }
        public static T JsonToObject<T>(this string t)
        {
            return System.Text.Json.JsonSerializer.Deserialize<T>(t);
        }
    }
